...
public class Listperiode2_8 extends Activity implements AdapterView.OnItemClickListener{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		c=myDbHelper.query1("per2_8", null, null, null, null,null, null);

		c.moveToFirst();
		jd = c.getCount();

		Toast.makeText(Listperiode2_8.this, "Jumlah data: "+jd+"...", Toast.LENGTH_LONG).show();	
		...
		String kata="PERIODE 2 SAMPAI 8 TERDAPAT 2 MASA PEMERINTAHAN YAITU PEMERINTAHAN SOEHARTO DAN PEMERINTAHAN BJ. HABIBIE ";
	...
	public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
		Toast.makeText(Listperiode2_8.this, "Pilihan Anda : "+arrNama[position-1]+"...", Toast.LENGTH_LONG).show();	

		Intent i = new Intent(Listperiode2_8.this, Isi_Data.class);
