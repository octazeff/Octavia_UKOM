...
public class Listperiode9 extends Activity implements AdapterView.OnItemClickListener{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		c=myDbHelper.query2("per9", null, null, null, null,null, null);

		c.moveToFirst();
		jd = c.getCount();

		Toast.makeText(Listperiode9.this, "Jumlah data: "+jd+"...", Toast.LENGTH_LONG).show();	
		...
		String kata="PERIODE 9 TERDAPAT 2 MASA PEMERINTAHAN YAITU PEMERINTAHAN ABDURRAHMAN WAHID DAN PEMERINTAHAN MEGAWATI SOEKARNOPUTRI ";
	...
	public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
		Toast.makeText(Listperiode9.this, "Pilihan Anda : "+arrNama[position-1]+"...", Toast.LENGTH_LONG).show();	

		Intent i = new Intent(Listperiode9.this, Isi_Data.class);
