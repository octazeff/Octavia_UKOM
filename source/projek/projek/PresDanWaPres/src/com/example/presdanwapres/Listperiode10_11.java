...
public class Listperiode10_11 extends Activity implements AdapterView.OnItemClickListener{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		c=myDbHelper.query3("per10_11", null, null, null, null,null, null);

		c.moveToFirst();
		jd = c.getCount();

		Toast.makeText(Listperiode10_11.this, "Jumlah data: "+jd+"...", Toast.LENGTH_LONG).show();	
		...
		String kata="PERIODE 10 SAMPAI 11 DIPIMPIN OLEH PEMERINTAHAN SUSILO BAMBANG YUDHOYONO - PERIODE 10 SAMPAI 11 DIPIMPIN OLEH PEMERINTAHAN SUSILO BAMBANG YUDHOYONO ";
	...
	public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
		Toast.makeText(Listperiode10_11.this, "Pilihan Anda : "+arrNama[position-1]+"...", Toast.LENGTH_LONG).show();	

		Intent i = new Intent(Listperiode10_11.this, Isi_Data.class);
